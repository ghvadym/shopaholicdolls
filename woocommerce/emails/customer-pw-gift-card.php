...
background-color: #92a8d1;
    ...
    #pwgc-email-gift-card-container {
        ...
        border-color: #333;
        border-radius: 16px;
        background: url(https://shopaholicdolls.com/wp-content/uploads/2019/12/Gift_Card-04.png);
        /* background: url(https://shopaholicdolls.com/wp-content/uploads/2019/12/Gift_Card-05.png);*/
        /* background: url(https://shopaholicdolls.com/wp-content/uploads/2018/10/promocje_laleczkowe.jpg);*/
...
<table id="pwgc-email-gift-card-container" height="275" width="100%">
    <tr>
        ...
        <td id="pwgc-email-title">
            <?php printf( __( '', 'pw-woocommerce-gift-cards' ), get_option( 'blogname' ) ); ?>
        </td>
        <td width="10"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="10"></td>
        <td>
            <div id="pwgc-email-amount-label" class="pwgc-email-label"><?php _e( 'Wartosc', 'pw-woocommerce-gift-cards' ); ?></div>
    ...
    <tr>
        <td width="10"></td>
        <td>
            <div id="pwgc-email-card-number-label" class="pwgc-email-label"><?php _e( 'Number eGift Card', 'pw-woocommerce-gift-cards' ); ?></div>
    ...
    <tr>
        ...
        <td>
            <div id="pwgc-email-redeem-button">
                <a href="<?php echo $item_data->redeem_url; ?>"><?php _e( 'Shop', 'pw-woocommerce-gift-cards' ); ?></a>
            </div>
        </td>
        <td width="10"></td>
    </tr>
