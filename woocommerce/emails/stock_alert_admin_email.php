...
<p><?php printf( __( "Witaj! Klient zapisał się na listę oczekujących do produktu w Twoim sklepie. Poniżej znajdują się szczegóły produktu:", 'woocommerce-product-stock-alert' ) ); ?></p>
<?php
...
<h3><?php _e( 'Szczegóły klienta', 'woocommerce-product-stock-alert' ); ?></h3>
<p>
