...
<p><?php printf( __( "Witaj. Właśnie zapisałaś się na powiadomienie o dostępności produktu w sklepie laleczkowym! Poinformujemy Cię, gdy produkt znów będzie dostępny. Poniżej znajdują się szczegóły produktu:", 'woocommerce-product-stock-alert' ) );
